...
#
our $RELEASE = '03 May 2018';

# One line description of the module
our $SHORTDESCRIPTION = 'Embed WaveDrom graphs into topics';
...
sub initPlugin {
    ...
    # like this:
    # $Foswiki::cfg{Plugins}{WaveDromPlugin}{ExampleSetting} = 1;
    ...
    # LocalSite.cfg.
    # my $setting = $Foswiki::cfg{Plugins}{WaveDromPlugin}{ExampleSetting} || 0;
